...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    protected void makeStatusBarView() {
        ...
        filter.addAction(CandyUtils.ACTION_DISMISS_KEYGUARD);
    ...
    private void setCutoutOverlay(boolean enable) {
        try {
            mOverlayManager.setEnabled("com.candy.overlay.hidecutout",
    ...
    private void setStatusBarStockOverlay(boolean enable) {
        try {
            mOverlayManager.setEnabled("com.candy.overlay.statusbarstock",
                        enable, mLockscreenUserManager.getCurrentUserId());
        } catch (RemoteException e) {
    ...
    private final BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            else if (CandyUtils.ACTION_DISMISS_KEYGUARD.equals(action)) {
                if (intent.hasExtra(CandyUtils.DISMISS_KEYGUARD_EXTRA_INTENT)) {
                    Intent launchIntent = (Intent) intent.getParcelableExtra(CandyUtils.DISMISS_KEYGUARD_EXTRA_INTENT);
    ...
    protected void updateTheme() {
        ...
        final boolean useDarkTheme = (userThemeSetting == 0 && (wallpaperWantsDarkTheme || nightModeWantsDarkTheme))
                || userThemeSetting == 2;
